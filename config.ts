...
const config = {
  ...
  appDescription:
    "letsxonnect is a organic follower growth service for X. We help you grow your followers with real users.",
  // REQUIRED (no https://, not trialing slash at the end, just the naked domain)
  domainName: "letsxonnect.com",
  crisp: {
  ...
  mailgun: {
    ...
    fromNoReply: `letsxonnect <noreply@mg.shipfa.st>`,
